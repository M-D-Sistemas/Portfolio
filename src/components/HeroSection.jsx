    ...
    <section className="relative mx-auto flex min-h-[calc(100vh-6rem)] w-full max-w-7xl items-center px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center text-center">
        <div className="w-full max-w-5xl">
          ...
          <h1 className="font-display mt-6 text-4xl font-bold tracking-tight text-white text-balance sm:text-5xl md:text-6xl lg:text-[5.9rem] lg:leading-[0.88] xl:text-[6.5rem]">
            <span className="block">Transformamos problemas complejos</span>
            <span className="block">en software a medida</span>
          </h1>

          <p className="mx-auto mt-6 max-w-3xl text-balance text-base leading-7 text-slate-300 sm:text-lg">
